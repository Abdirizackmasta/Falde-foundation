    ...
    <div className={styles.the_team}>
      ...
      <div className={styles.div_1}>
        ...
        <p className={styles.p2}>
          Falde Foundation leadership is dedicated to our mission and to
          continuing the legacy of innovation to help people build better lives
          and more durable futures.
        </p>
      </div>
