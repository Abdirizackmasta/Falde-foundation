    ...
    return (
        <motion.div
            ...
            <motion.div
                ...
                <img src="/blackandwhite.jpeg" alt="" className={styles.about_bg_img}/>
                <motion.h1  variants={fadeIn("right", "tween", 0.9, 1)}>About <span>us</span></motion.h1>
                <motion.p variants={fadeIn("left", "tween", 0.9, 1)}className={styles.hero_p}>Falde Foundation inspires change so people and nature thrive</motion.p>
            </motion.div>
